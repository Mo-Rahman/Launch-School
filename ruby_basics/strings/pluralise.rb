...
# As discussed in the previous exercise, String#split will split elements in a string according to 
# the provided argument. In this case, we pass in a string consisting of a single space, which means #split 
