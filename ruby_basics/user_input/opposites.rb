...
# Do not check for positive/negative requirement until after both integers are entered, and start over if the 
...
def read_input
  loop do
    puts "<< Please enter a postive or negative integer (whole number!):"
    number = gets.chomp
...
loop do 
  first_number = read_input
  second_number = read_input
...
# Launch school solution !  Need to be able to do stuff like this using my own mental capacity!
